<?php
$id_kas = $_GET['id'];
$query_id = mysqli_query($koneksi, "SELECT * FROM kas WHERE id='$id_kas'");
    ...
    <div class="container-fluid">
        <div class="card shadow mb-4">
            ...
            if (isset($_POST['edit'])) {
                ...
                $edit = mysqli_query($koneksi, "UPDATE kas SET jumlah = '$jumlah', tanggal = '$tanggal' WHERE id = '" . $_GET['id'] . "' ");

                if ($edit) {
            ?>

                    <script language="JavaScript">
                        document.location.href = 'index.php?page=daftar_kas';
                    </script>
